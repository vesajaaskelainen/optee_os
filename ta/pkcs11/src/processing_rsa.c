...
void tee_release_rsa_pss_operation(struct active_processing *proc)
{
	TEE_Free(proc->extra_ctx);
	proc->extra_ctx = NULL;
}
...
void tee_release_rsa_oaep_operation(struct active_processing *proc)
{
	TEE_Free(proc->extra_ctx);
	proc->extra_ctx = NULL;
}
